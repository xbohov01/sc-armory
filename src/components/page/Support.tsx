      ...
      <Accordion allowToggle width='300pt'>
        <AccordionItem>
          ...
          <AccordionPanel pb={4} textAlign='left'>
            ...
            <p>
              Alternatively, if you REALLY want to, there is some <Link textDecoration='underline' href='https://www.redbubble.com/shop/ap/89403056'>merch</Link>. More options/items can be added per request.
            </p>
          </AccordionPanel>
        </AccordionItem>
      </Accordion>
